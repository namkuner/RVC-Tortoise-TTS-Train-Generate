...
def inference_tfdpc5_with_cheater():
    with torch.no_grad():
        ...
        for k, sample in samples.items():
            ...
            from dlas.models.diffusion.respace import (SpacedDiffusion,
                                                  space_timesteps)
            ...
            from dlas.models.audio.music.transformer_diffusion12 import \
            ...
            from dlas.utils.music_utils import get_mel2wav_v3_model
            ...
            spectral_diffuser = SpacedDiffusion(use_timesteps=space_timesteps(4000, [32]), model_mean_type='epsilon',
                                   model_var_type='learned_range', loss_type='mse', betas=get_named_beta_schedule('linear', 4000),
                                   conditioning_free=True, conditioning_free_k=1)
            from dlas.trainer.injectors.audio_injectors import denormalize_torch_mel
            ...
            from dlas.trainer.injectors.audio_injectors import pixel_shuffle_1d
